...
def scan(scanAmount):
    ...
    for x in range(scanAmount):
        ...
        sensor1 = ultrasonic_esp.distance(ultrasonic_esp.trigger1, ultrasonic_esp.echo1)
        # sensor1 = 3
        sensor2 = ultrasonic_esp.distance(ultrasonic_esp.trigger2, ultrasonic_esp.echo2)
        sensor2 = 7
        sensor3 = tof_esp.tofsensor.readDistance() / 100  # convert cm to m
        # sensor3 = 9
